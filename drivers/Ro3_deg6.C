...
// Our goal is to search for a degree=6 rule with 10 total unknowns, 1
// centroid and 3 Ro3-invariant points. A rule like this has not been
// reported in the literature, most likely because it does not exist.
//
  ...
  while (true)
    {
      ...
      // Remove this to do multiple rounds of testing
      break;
    }
